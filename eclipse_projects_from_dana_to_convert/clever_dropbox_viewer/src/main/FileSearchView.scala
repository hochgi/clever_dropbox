...
class FileSearchView (display2:Display, shell2:Shell){
  ...
  def initGUI() {
    ...
    // initialize Tool Bar
    toolBar = new ToolBar(shell, SWT.BORDER_DASH)
   ...
   // settingsListener.add("change")
    ...
    composite.setSize(788,590);
    {
      ...
      menu.setLayoutData(menuLData);
	  {
		...
		sortBy.setImage(new Image(display, "sortIcon.jpg"))
		sortBy.setHeight(60)
		sortBy.setHeight(60);
		{
		...
		}
		{
		...
		}
  		{
			...
			showAllFiles.setImage(new Image(Display.getDefault(),"showFiles.png"));
  		...
  		}
  		{
			...
			addNewTag.setImage(new Image(Display.getDefault(),"addTag.png"))
		...
		}
  		{
			...
			removeTag.setImage(new Image(Display.getDefault(),"removeTag.png"))
		...
		}
		{
			...
			renameTag.setImage(new Image(Display.getDefault(),"renameTag.png"))
		...
		}
		{
			...
			openFile.setImage(new Image(Display.getDefault(),"openFile.png"))
		...
		}
		{
			...
			var trashImg = new Image(Display.getDefault(),"trash.png");
	...
	}
	{
		...
		plusTag.setImage(new Image(Display.getDefault(),"plus.png"));
